...
import { MessageCircle, Users, Loader2, AlertTriangle, BookOpen } from 'lucide-react';
      ...
      <div className="max-w-[720px] mx-auto space-y-8">
        ...
        {showSetup && setup && (
          <div className="rounded-xl bg-bg-card border border-border p-6 space-y-4">
            ...
            <p className="text-xs text-green-400 font-medium">Cost: {setup.cost}</p>
          </div>
        )}
        ...
        <div className="rounded-xl bg-bg-card border border-border p-6 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-text-secondary mb-2">API ID</label>
            ...
            <div>
              <label className="block text-xs font-medium text-text-secondary mb-2">API Hash</label>
          ...
          <div>
            <label className="block text-xs font-medium text-text-secondary mb-2">Phone Number (with country code)</label>
        ...
        <div className="rounded-xl bg-bg-card border border-border p-6 space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-text-secondary mb-2">Group Username or Link</label>
