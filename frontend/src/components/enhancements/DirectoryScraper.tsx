    ...
    <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
      <div className="shrink-0 page-header">
        <div className="px-10 py-6">
          ...
          <p className="text-sm text-text-secondary pt-1 ml-[52px]">Search YellowPages & Yelp for business leads</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-bg-card rounded-xl border border-border p-7 space-y-6">
          <div>
            <label className="block text-sm font-medium text-text-primary pb-3">Business Type / Query</label>
            <input
              type="text"
              value={query}
          ...
          <div>
            <label className="block text-sm font-medium text-text-primary pb-3">Sources</label>
